...
export class DistrictsComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.districtsService
      ...
      .subscribe({
        next: (res: HttpResponse<IDistricts[]>) => {
  ...
  trackCode(_index: number, item: IDistricts): string {
    return item.code!;
  }

  delete(districts: IDistricts): void {
    const modalRef = this.modalService.open(DistrictsDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IDistricts[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
