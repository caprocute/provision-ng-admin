...
export class WardsComponent implements OnInit {
  ...
  trackCode(_index: number, item: IWards): string {
    return item.code!;
  }

  delete(wards: IWards): void {
    const modalRef = this.modalService.open(WardsDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.wards = wards;
  ...
  protected onSuccess(data: IWards[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
