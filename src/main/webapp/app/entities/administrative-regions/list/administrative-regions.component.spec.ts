...
describe('AdministrativeRegions Management Component', () => {
  let comp: AdministrativeRegionsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'administrative-regions', component: AdministrativeRegionsComponent }]),
      ...
      .overrideTemplate(AdministrativeRegionsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.administrativeRegions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
