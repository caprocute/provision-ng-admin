...
describe('AdministrativeUnits Management Component', () => {
  let comp: AdministrativeUnitsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'administrative-units', component: AdministrativeUnitsComponent }]),
      ...
      .overrideTemplate(AdministrativeUnitsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.administrativeUnits?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
