...
This is a project generated with `ngx-admin 8.0.0 template compatible with jhipster 7.8.1`
...
To build the final jar and optimize the Provision application for production, run:
